...
export const CreateGroupModal = ({ isOpen, onClose, auth }: { isOpen: boolean; onClose: () => void; auth: any }) => {
  ...
  const handleSubmit = () => {
    ...
    axios
      .post(`${BACKEND_URL}/api/v1/group-management/groups`, groupObj, {
        headers: {
        ...
        <ModalBody>
          <VStack spacing={4}>
            <FormControl>
              ...
              <Input
                placeholder="must be unique from all other groups"
                value={group.id}
            ...
            <FormControl>
              ...
              <Input
                placeholder="i.e. Dashboard Viewers"
                value={group.name}
            ...
            <FormControl>
              ...
              <Textarea
                placeholder="i.e. viewers and editors of the dashboard"
            ...
            <FormControl>
              ...
              <Button
                ...
                onClick={() =>
                  setGroup((prev) => ({
                    ...prev,
                    attributes: [...(prev.attributes || []), { id: Date.now(), key: "", value: [] }],
                  }))}
              >
                Add Attribute
              </Button>
            ...
            <FormControl>
              ...
              <TagsInput
                ...
                onChange={(tags) => setGroup((prev) => ({ ...prev, client_roles: tags }))}
                name="client_roles"
                placeHolder="i.e. grafana:viewer"
              />
            </FormControl>
            ...
            <FormControl>
              ...
              <TagsInput
                ...
                onChange={(tags) => setGroup((prev) => ({ ...prev, realm_roles: tags }))}
                name="realm_roles"
                placeHolder="i.e. grafana:viewer"
              />
            </FormControl>
